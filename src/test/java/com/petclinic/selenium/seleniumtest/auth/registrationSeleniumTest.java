...
public class registrationSeleniumTest {
    ...
    public registrationSeleniumTest(ChromeDriver driver) {
        this.driver = driver;
    ...
    void valid_input_test(TestInfo testInfo) throws Exception {
        ...
        WebElement registrationHeader = driver.findElement(By.xpath("//*[@id=\"bg\"]/div/div/div/ui-view/signup-form/div/div/h2"));
        TimeUnit.SECONDS.sleep(2);

        //Enter username information
        WebElement usernameBox = driver.findElement(By.xpath("//*[@id=\"bg\"]/div/div/div/ui-view/signup-form/div/div/div/form/div[1]/input"));
        usernameBox.sendKeys("testUsername");
        TimeUnit.SECONDS.sleep(2);


        //Enter password information
        WebElement passwordBox = driver.findElement(By.xpath("//*[@id=\"bg\"]/div/div/div/ui-view/signup-form/div/div/div/form/div[2]/input"));
        passwordBox.sendKeys("GoodPa$$word123");
        TimeUnit.SECONDS.sleep(2);

        //Enter email information
        WebElement emailBox = driver.findElement(By.xpath("//*[@id=\"bg\"]/div/div/div/ui-view/signup-form/div/div/div/form/div[3]/input"));
        emailBox.sendKeys("good@email.com");
        TimeUnit.SECONDS.sleep(2);

        //Press the submit button
        WebElement submitButton = driver.findElement(By.xpath("//*[@id=\"bg\"]/div/div/div/ui-view/signup-form/div/div/div/form/div[4]/button"));
        submitButton.click();
        TimeUnit.SECONDS.sleep(2);
        ...
        assertThat(registrationHeader.getText(), is("Signup"));
    ...
    @Test
    @DisplayName("Test_empty_username")
    void empty_username_test(TestInfo testInfo) throws Exception {
